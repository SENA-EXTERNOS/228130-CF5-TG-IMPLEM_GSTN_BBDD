  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
          ...
          .col-md-6.mb-4.mb-md-0
            ol.lista-ol--cuadro
              ...
              li 
                .lista-ol--cuadro__vineta
                  span 7
                | Desarrollar los <i>scripts</i> que realicen el proceso ETL para poblar la bodega.
    ...
    .tarjeta.linea-tiempo-dos.p-4.mb-5
      LineaTiempoC.color-primario(text-small)
        ...
        .row.justify-content-around.align-items-center(titulo="Paso 3")
          .col-md-6.mb-4.mb-md-0
            p Se debe contar con un servidor con estas características de <i>software</i>:
        ...
        .row.justify-content-around.align-items-center(titulo="Paso 4")
          .col-md-6.mb-4.mb-md-0
            p El servidor debe tener las siguientes características de <i>hardware</i>:
        ...
        .row.justify-content-around.align-items-center(titulo="Paso 5")
          p.mb-3 Los campos para extraerse de cada fuente corresponden a lo siguiente:
    ...
    .tarjeta.config-slyder.p-4.mb-5
      SlyderA(tipo="b")
        ...
        .row.justify-content-around.align-items-center
          .col-md-6.mb-4.mb-md-0
            h4.mb-4 Business analyst requirements
        ...
        .row.justify-content-around.align-items-center
          .col-md-6.mb-4.mb-md-0
            h4.mb-4 Data modeler and conceptual/logical
        ...
        .row.justify-content-around.align-items-center
          .col-md-6.mb-4.mb-md-0
            h4.mb-4 Database administrator and physical database designer
